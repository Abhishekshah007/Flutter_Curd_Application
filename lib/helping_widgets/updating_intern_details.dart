...
class UpdatingInternDetails extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => UpdatingInternDetailsState();
}
...
class UpdatingInternDetailsState extends State<UpdatingInternDetails> {
  ...
  // Method to update the intern data in the database
  void _updateInternData()  {
    final updatedData = InternTableCompanion(
    ...
    _internDatabase.updateInternById(updatedData);

    // Show a snackbar to confirm the data update
  ...
  // Method to get the intern data from the database and populate the text fields
